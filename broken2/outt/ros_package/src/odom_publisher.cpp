...
private:
    void state_callback(const unitree_go::msg::SportModeState::SharedPtr msg) {
        ...
        // V14 (2026-05-21): also publish body-frame angular velocity from
        // the IMU gyroscope. Downstream CBF inference can then pull both
        // linear + angular velocity from a single /odom subscription.
